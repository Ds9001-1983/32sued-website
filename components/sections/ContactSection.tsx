            ...
            <div className="grid grid-cols-2 gap-2.5 lg:gap-3">
              <div className="dark-card p-3 lg:p-4 flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-gray text-[10px] lg:text-[11px]">{CONTACT.street}, {CONTACT.city}</p>
                </div>
              </div>
              <div className="dark-card p-3 lg:p-4 flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <a href={`tel:${CONTACT.phoneIntl}`} className="text-gold hover:text-gold-light transition-colors text-[10px] lg:text-[11px]">{CONTACT.phone}</a>
                </div>
              </div>
              <div className="dark-card p-3 lg:p-4 flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <a href={`mailto:${CONTACT.email}`} className="text-gold hover:text-gold-light transition-colors text-[10px] lg:text-[11px]">{CONTACT.email}</a>
                </div>
              </div>
              <div className="dark-card p-3 lg:p-4 flex items-start gap-2.5">
                ...
                <div>
                  ...
                  <div className="space-y-0">
                    {OPENING_HOURS.map((item) => (
                      <div key={item.day} className="flex justify-between text-[10px] lg:text-[11px] gap-1.5">
